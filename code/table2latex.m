...
function table2latex(T, filename)
    ...
    T_aux = T;
    for l = 1:length(T.Properties.VariableNames) T_aux.Properties.VariableNames{l} = toLatexGreek(T.Properties.VariableNames{l}); end
    col_names = strjoin(T_aux.Properties.VariableNames, ' & ');
