...
%solvpara1int = [1/2,3/4,0.563]; %gamma
solvpara1int = [0.75];
...
for testpair = tests
   ...
   %for i = 1:size(A,1)
    ...
    %fprintf(fileID,'%12s %12s %12s %12s %12s %12s %12s\n','Beta1','Beta2', 'Beta3','Alpha2', 'tol','para','solvpara1' , 'accepted', 'rejected', 'error');
